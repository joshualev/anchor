...
const Sidebar = () => {
    ...
    transition-all duration-300 h-full z-40 dark:bg-black bg-white overflow-y-auto
    ...
    <div className={sidebarClassNames}>
        <div className="flex h-[100%] w-full flex-col justify-start">
            ...
            <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                <Image src="https://anchor-s3-images.s3.ap-southeast-2.amazonaws.com/logo.png" alt="logo" width={40} height={40} />
                <div>
        ...
        <div className="flex w-full items-center">
            <div className="align-center flex h-9 w-9 justify-center">
                {!!currentUserDetails?.profilePictureUrl ? (
                    <Image 
                        src={`https://anchor-s3-images.s3.ap-southeast-2.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
